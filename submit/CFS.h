...
struct rb_tree* compute_schedule(struct rb_tree *tree, cfs_pnode *execute_buf[], int *exec_size, cfs_pnode *arrival_buf[], int *buf_size);
void check_cfs_queue(process_info processes[], cfs_pnode *arrival_buf[], int *buf_size, int num_processes, int time);
